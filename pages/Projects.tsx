        ...
        <div className=" grid xl:grid-cols-3 ">
         ...
         <div className="">
          ...
          <div className="  xl:grid xl:grid-cols-1 2xl:grid-cols-2 animate-in fade-in gap-1 xl:rounded-sm col-span-2 xl:col-span-2 2xl:col-span-2  overflow-hidden ">
            ...
            <Link className='' href={'/NFTPage'}><motion.div data-aos="flip-up" data-aos-offset="0" data-aos-delay="180" data-aos-duration="9000" className="2xl:col-span-1 2xl:h-[400px]  xl:rounded-lg bg-gradient-to-r from-indigo-500 to flex h-40 sm:h-80  nft bg-center to-blue-400   col-span-1 cursor-pointer gap-2 mr-1 "></motion.div></Link>
            ...
            <Link className='' href={'/FilmduoPage'}><motion.div data-aos="flip-up" data-aos-offset="0" data-aos-delay="190" data-aos-duration="9000" className="2xl:col-span 2xl:h-[400px] 2xl:col-span-1 xl:col-span-3 xl:rounded-lg  justify-center h-60  sm:h-80 flex filmduo bg-black cursor-pointer gap-2 mr-1 "></motion.div></Link>           
          </div>
        </div>
    </motion.div> 
  )
