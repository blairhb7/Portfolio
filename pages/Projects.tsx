  ...
  return (
     ...
     <motion.div   className=''>
        ...
        <div className=" grid xl:grid-cols-3 2xl:grid-cols-2">
          ...
          <div className="xl:bg-white xl:grid xl:h-[900px] xl:justify-center xl:w-[600px] lg:w-[400px] 2xl:w-[800px] bg-no-repeat 2xl:h-screen xl:bg-center Movement xl:fixed hidden">
         ...
         <div className="">
          ...
          <div className="  xl:grid xl:grid-cols-1 2xl:grid-cols-3 animate-in fade-in gap-1 xl:rounded-sm col-span-2 xl:col-span-2 2xl:col-span-3  overflow-hidden ">
