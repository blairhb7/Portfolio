  ...
  return (
     ...
     <motion.div   className=''>
        ...
        <div className=" grid xl:grid-cols-3 ">
          ...
          <div className="xl:bg-white xl:grid xl:h-[900px] xl:justify-center xl:w-[600px] lg:w-[400px] 2xl:w-[800px] bg-no-repeat 2xl:h-screen xl:bg-center Movement bg-cover xl:fixed hidden">
         ...
         <div className="">
          ...
          <div className="  xl:grid xl:grid-cols-1 2xl:grid-cols-2 animate-in fade-in gap-1 xl:rounded-sm col-span-2 xl:col-span-2 2xl:col-span-2  overflow-hidden ">
            <Link className='hover:scale-105' href={'/TravelPage'}><motion.div data-aos="flip-up" data-aos-offset="0" data-aos-delay="120" data-aos-duration="9000"  className="2xl:col-span-1 xl:col-span-3 xl:h-[600px] xl:rounded-lg  sm:h-80 h-40 flex justify-center travel bg-cover cursor-pointer gap-2 hover:scale-105 mr-1 "></motion.div></Link>
            <Link className='' href={'/NFTPage'}><motion.div data-aos="flip-up" data-aos-offset="0" data-aos-delay="180" data-aos-duration="9000" className="2xl:col-span-1 2xl:h-[600px]  xl:rounded-lg bg-gradient-to-r from-indigo-500 to flex h-40 sm:h-80  nft bg-center to-blue-400   col-span-1 cursor-pointer gap-2 mr-1 "></motion.div></Link>
