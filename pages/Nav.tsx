    ...
    <motion.div variants={stagger}  exit={{opacity: 0}} initial='initial' animate='animate'>
        <motion.div variants={stagger} className="bg-gray-400 z-30 backdrop-blur-lg bg-opacity-30  xl:flex flex-col  fixed backdrop-opacity-90 xl:w-20 h-screen hidden w-10">
           ...
           <motion.div variants={fadeInUp} className="flex flex-col justify-center items-center gap-4 mt-14">
            <div className="tooltip  flex-row"><Link href={'/'}><HomeIcon className='xl:w-6 xl:h-6 w-4 h-4 items-center justify-center flex text-black  icon' /></Link><span className='tooltiptext bg-black'>HOME</span></div>
            <div className="tooltip  flex-row"><Link href={'/Projects'}><CodeBracketIcon className='xl:w-6 xl:h-6 w-4 h-4 items-center justify-center flex text-red-500 cursor-pointer icon' /></Link><span className='tooltiptext bg-red-500'>WORK</span></div>
            <div className="tooltip  flex-row"><Link href={'/About'}><PaperAirplaneIcon className='xl:w-6 xl:h-6 w-4 h-4 items-center justify-center flex text-green-500 cursor-pointer icon' /></Link><span className='tooltiptext bg-green-500'>ABOUT</span></div>
            <div className="tooltip  flex-row"><Link href={'/Contact'}><DevicePhoneMobileIcon className='xl:w-6 xl:h-6 w-4 h-4 items-center justify-center flex text-blue-500 cursor-pointer icon' /></Link><span className='tooltiptext bg-blue-500'>CONTACT</span></div>
           </motion.div>
